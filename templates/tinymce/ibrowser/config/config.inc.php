<?php
	...
	// ================================================
	// Revision: 1.3.3                 Date: 06/08/2006
	// ================================================
	...
	//-------------------------------------------------------------------------	
	$cfg['lang']   		= 'ru';														// default language; e.g. 'en'		
...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/templates/tinymce/ibrowser/site/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> '/templates/tinymce/ibrowser/gallery/', 				
			'text'    	=> 'Gallery',
		),	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ver'] 		= '1.3.3 - build 06082006';										// iBrowser version	
