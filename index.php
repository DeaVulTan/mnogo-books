...
$sql = "SELECT books.*,books.name_" . SelectedLanguage . " AS name, books.annotation_" . SelectedLanguage . " AS annotation, authors.name_" . SelectedLanguage . " AS author,genre.name_" . SelectedLanguage . " AS genre_name
